...
document.addEventListener("DOMContentLoaded", event => {
    ...
    db.collection('raiLeads').where('SalesStatus', '==', "New").get().then(
        (snapshot) => document.getElementById('tableCountLanding').innerHTML = snapshot.docs.length
   ...
   db.collection("raiLeads").where('SalesStatus', '==', "New").get().then(function(querySnapshot) {
