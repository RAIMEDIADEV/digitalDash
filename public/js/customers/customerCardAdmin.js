...
function customerSalesCard(e){
    ...
    document.getElementById("companyInfoHeader").innerHTML = e;
...
//======================================================================================== BUSINESS STATUS
    ...
    businessStatus.setAttribute("data-toggle","modal");
    businessStatus.setAttribute("data-target","#smallmodalStatusChange");
    businessStatus.setAttribute("id","customerContentpStatus");
...
//======================================================================================== BUSINESS Sales Status
    ...
    businessSalesStatus.setAttribute("id","customerContentSalesStatus");
...
const leftHeaderButton = document.createElement('button');
leftHeaderButton.setAttribute("onclick","openScript()");
const leftHeaderButtonText = document.createTextNode('Script');
leftHeaderButton.appendChild(leftHeaderButtonText);
...
left.appendChild(leftHeaderButton);
...
const NoteSection = firestore.collection("raiLeads").doc(e);
NoteSection.get().then(function(doc) {
    var body = document.getElementById("noteDiv");

    const row = document.createElement("ul");
    row.setAttribute('class', "list-group");
    row.setAttribute('id', "noteDivChild");


    const note = doc.data().Notes;
    const noteT = doc.data().NoteTime;
    var newNote = note.reverse();
    var newNoteT = noteT.reverse();
    ...
    for (var j = 0; j < note.length; j++) {
        ...
        var cellText = document.createTextNode(newNote[j]);
        var str = new String (new Date(newNoteT[j].seconds * 1000));
